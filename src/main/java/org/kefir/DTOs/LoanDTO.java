...
public class LoanDTO {
    ...
    // Constructor
    public LoanDTO(int id, int customer, int loanType, double totalOperationAmount, Date openingDate,
                   int currency, Date expirationDate, int totalTermDays, Date closedDate, int closedCode,
                   Date nextInstallmentDate, int status, Date lastModificationDate, int coreUser) {
        this.id = id;
    ...
    public double getTotalOperationAmount() { return totalOperationAmount; }
    public Date getOpeningDate() { return openingDate; }
    public int getCurrency() { return currency; }
    public Date getExpirationDate() { return expirationDate; }
    public int getTotalTermDays() { return totalTermDays; }
    public Date getClosedDate() { return closedDate; }
    public int getClosedCode() { return closedCode; }
    public Date getNextInstallmentDate() { return nextInstallmentDate; }
    public int getStatus() { return status; }
    public Date getLastModificationDate() { return lastModificationDate; }
    public int getCoreUser() { return coreUser; }
}